...
class BSC_Elementor_Form_Brewery_Widget extends \Elementor\Widget_Base {

	public function get_name() {
		return 'bsc_form_brewery';
	}

	public function get_title() {
		return __( 'Formulaire Brasserie', 'bsc-brew-manager' );
	}
	...
	protected function render() {
		echo do_shortcode( '[bsc_add_brewery]' );
	}
}
